...
%fuelUsed1 = 0;
 ...
 inT(1,:) = array2table([param1.BlockTime2 param1.FlightTime2 dayofYear2 param1.distance param1.fieldElev1 ...
     param1.fieldElev2 hourofDay2 payload2 totalWeight2]);
...
landingWeight2 = totalWeight2 - double(fuelUsed1) ;
